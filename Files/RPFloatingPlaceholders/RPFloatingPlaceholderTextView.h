...
typedef void (^TextDidChange)(NSString * _Nullable text);
...
@property (nonatomic, copy, nullable) TextDidChange textChanged;

-(void)textDidChange:(TextDidChange _Nullable )text;
