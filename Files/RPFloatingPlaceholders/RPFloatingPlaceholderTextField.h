...
typedef void (^TextFieldDidChangeText)(NSString * _Nullable text);
...
@property (nonatomic, copy, nullable) TextFieldDidChangeText textChanged;

-(void)textDidChange:(TextFieldDidChangeText _Nullable )text;
